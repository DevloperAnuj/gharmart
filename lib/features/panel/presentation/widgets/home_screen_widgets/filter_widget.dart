                ...
                Wrap(
                  ...
                  children: [
                    CustomChoiceChip(
                      ...
                      onSelected: (val) {
                        context.read<ListingFilterCubit>().applyBhkType("1 RK");
                      },
                    ),
                    CustomChoiceChip(
                      label: "1 BHK",
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    CustomChoiceChip(
                      ...
                      onSelected: (val) {
                        context.read<ListingFilterCubit>().applyPrefTent("All");
                      },
                    ),
                  ],
                ),
                ...
                Wrap(
                  ...
                  children: [
                    CustomChoiceChip(
                      ...
                      onSelected: (val) {
                        context.read<ListingFilterCubit>().applyParking("Bike");
                      },
                    ),
                    CustomChoiceChip(
                      label: "Car",
                      ...
                      onSelected: (val) {
                        context.read<ListingFilterCubit>().applyParking("Car");
                      },
                    ),
                    CustomChoiceChip(
                      label: "Bike And Car",
                    ...
                    CustomChoiceChip(
                      ...
                      onSelected: (val) {
                        context.read<ListingFilterCubit>().applyParking("None");
                      },
                    ),
                  ],
                ),
