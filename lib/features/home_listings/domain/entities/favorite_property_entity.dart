...
class FavoritePropertyEntity {
  ...
  FavoritePropertyEntity copyWith({
    String? id,
    DateTime? createdAt,
    Property? property,
    String? user,
  ...
  factory FavoritePropertyEntity.fromJson(String str) => FavoritePropertyEntity.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory FavoritePropertyEntity.fromMap(Map<String, dynamic> json) => FavoritePropertyEntity(
    id: json["id"],
