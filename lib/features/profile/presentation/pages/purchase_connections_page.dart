      ...
      child: Column(
        children: [
          ...
          const MembershipCard(
            ...
            membershipName: "Gold",
            membershipPrice: "999",
            membershipInfo: "You Will Get 20 Connections",
          ),
          const MembershipCard(
            cardColour: Colors.blueAccent,
            membershipName: "Silver",
            membershipPrice: "599",
            membershipInfo: "You Will Get 10 Connections",
          ),
          const MembershipCard(
            cardColour: Colors.orangeAccent,
            membershipName: "Single",
            membershipPrice: "69",
            membershipInfo: "You Will Get 1 Connection",
          ),
        ],
      ),
    );
